...
class Context(ContextInterface):
    ...
    def get_current_scope_value_variable(self, name):
        value = self._current_scope.get_value_variable(name)
        return value

    def set_expected_return_type(self, type):
        self._expected_return_type = type

    def get_expected_return_type(self):
        return self._expected_return_type
